...
tags = ["airén", "albarello", "albillo", "alella", "alicante", "almansa", "amontillados", "ampurdan-costa brava", "andalucia", "aragon", "aragonés", "baja montana", "bierzo", "binisalem", "bobal", "borraçal", "cabernet sauvignon", "caiño tinto", "calcaire", "callet", "campo de borja", "carignan", "cariñena", "castilla-la mancha", "castilla-leon", "catalogne", "cencibel", "conca de barbera", "condado de huelva", "costers del segre", "creams", "crianza de flor", "denominacion de origen", "denominacion de origen califada", "dona blanca", "espadeiro", "espagne", "estrémadure", "ferron", "finos", "galice", "garnacha", "garnatxa pelude", "graciano", "granatxa", "granciano", "grao negro", "grenache", "grenache poilu", "gual", "ibiza", "juan garcia", "jumilla", "la mancha", "las palmas", "le guide peñín", "leon", "listan blanc", "listan noir", "listàn negro", "llanovid", "lledoner pelut", "loudeiro", "lull de lebbre", "macabeo", "malaga", "malbec", "malvasia", "malvoisia", "malvoisie", "manto negro", "manzanillas", "mazuelo", "mencía", "mentrida", "merenzao", "merlot", "merseguera", "monastrell", "montilla", "morrastel", "moscatel", "mouraton", "mourvèdre", "navarre", "negramoll", "negreda", "olorosos", "palomino", "pansa blanca", "parellada", "pedro ximénez", "phylloxéra", "picapoll negro", "pin tea", "pinot noir", "piquepoul noir", "priorato", "rancio", "rias baixas", "ribeiro", "ribera alta", "ribera baja", "ribera del duero", "rioja", "rioja alavesa", "rioja alta", "rioja baja", "romains", "rueda", "samsó", "somontano", "souson", "syrah", "tacoronte-acentejo", "tarragona", "tempranillo", "tenerife", "terra alta", "tierra de barros", "tierra estella", "tinta del pais", "tintilla de rota", "tinto fino", "tintorera", "toro", "torrontes", "tortosi", "treixaduras", "utiel-requena", "valdeorras", "valdepenas", "valdizarbe", "valence", "valencia", "vega sicilia", "verdejo", "vino de calidad", "vino de crianza", "vino de gran reserva", "vino de mesa", "vino de reserva", "vino de tea", "vino de tierra", "vino joven", "vinos de pago", "viura", "xare-lo", "xérès", "yecla", "îles baléares", "îles canaries"] 
title = "L'Espagne"
...
* **Ribeiro** L’appellation touche la frontière portugaise. Le climat est relativement humide et les cépages rouges sont les Garnacha, Alicante, Mencía et Ferron et Palomino, Treixaduras et Torrontes pour les blancs, qui sont meilleurs. Les vins sont bien équilibrés en acidité, assez alcoolisés (de 9 à 13°), à la fois nerveux et souples en bouche.

* **Valdeorras** Plus à l’intérieur des terres espagnoles, en remontant vers la région de Leon, se trouve la petite appellation Valdeorras, plantée des cépages Garnacha, Mencía et Grao Negro pour les rouges, et Palomino, Dona blanca et Albillo pour les blancs. Le climat est beaucoup plus continental, avec des influences océaniques relativement importantes.
...
* **Tierra Estella** 26 communes (Bargota, Sanson, Los Arcos, Arellano…) font partie de cette aire, située au sud-ouest, et plantée de Tempranillo, Garnacha, Viura (de jolis blancs vifs et parfumés), Mazuelo et Granciano. Quelques bons rouges.
...
* **Carinena** Le vignoble est situé au sud de Zaragoza, de climat continental comme celui de Campo de Borja, avec des précipitations faibles. Des rouges de 14°, bien évidemment chauds et intenses, qu’il faut rafraîchir un peu, surtout s’ils sont jeunes. Bons rosés, frais, pleins et persistants.
...
* **Bierzo** Très peu connue, une DO où l’on produit des vins des trois couleurs, les rouges et rosés étant issus des cépages Mencía et/ou Garnacha.
...
**Le guide Peñín** est l’une des références incontournables des vins espagnols. Le statut de José Peñín créateur du guide est comparable à celui de Robert Parker aux Etats Unis. Son travail de journaliste et rédacteur de vin depuis plus de 25 ans lui a permis de développer son savoir sur le monde viticole.
