+++
categories = ["Cépages"]
date = "2023-07-28T17:30:22+00:00"
tags = ["achéria", "afrique du sud", "ampélographie", "anjou", "aquitaine", "argentine", "assemblage", "australie", "bergerac", "berton", "bordeaux", "bordo", "bouchet", "bouchy", "bourgueil", "breton", "béarn", "cabernet", "cabernet franc", "cabernet sauvignon", "cacao", "californie", "canada", "carmenet", "cassis", "cerise", "chili", "chine", "chinon", "climat", "coing", "complexité", "croatie", "cuve", "cépage", "côtes-de-bergerac", "débourrement", "espagne", "europe", "feuille de lierre", "finesse", "floral", "fougère", "france", "frioul", "fruits noirs", "fruits rouges", "gaillac", "groseille", "grosse vidure", "hondarrabi beltza", "hongrie", "iris", "italie", "languedoc", "madiran", "malbec", "merlot", "messanges", "montravel", "méditerranée", "médoc", "mûre", "navarre", "noir dur", "nouvelle-zélande", "pays basque", "petite vidure", "poivre", "poivron", "poivron vert", "pomerol", "pyrénées", "pécharmant", "rosé", "roumanie", "saint-nicolas-de-bourgueil", "saint-émilion", "saumur", "saumur-champigny", "sauvignon", "sauvignon blanc", "souple", "sous-bois", "soyeux", "stellenbosch", "sud-ouest", "tabac", "tanins", "tanins soyeux", "terroir", "touraine", "tuffeau", "val de loire", "vallée de la loire", "vendange", "violette", "véron"]  
title = "Le cabernet"
writer = "LeChaps"
+++
...
Le cabernet franc est également présent à l’étranger. En Europe, on le retrouve présent :
...
Les plus grands cabernets francs naissent entre la Touraine et le Saumurois où le tuffeau (craie) forme le socle commun.  
