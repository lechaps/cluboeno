...
tags = ["agriculture biodynamie", "agrume", "chardonnay", "charpenté", "cire", "complexité", "domaine grosbot-barbara", "fruits exotiques", "fruits rouges", "gamay", "les domaines des terres d'ocres", "mangue", "méthode traditionnelle", "phylloxéra", "pinot gris", "pinot noir", "poire", "pomme", "rondeur", "saint-pourçain", "salin", "soyeux", "tanins fondus", "tanins", "tension", "terroir argilo-calcaire", "terroir argilo-graveleux", "terroir granitique", "tressallier", "val de loire", "élégant", "équilibre"] 
